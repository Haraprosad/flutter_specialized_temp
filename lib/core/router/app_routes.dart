...
class AppRoutes {
  ...
  List<RouteBase> get _authRoutes => [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          RouteTransitions.slideTransition(const RegisterScreen()),
    ),
  ];
  ...
  ShellRoute get _mainShellRoute => ShellRoute(
    ...
    routes: [_homeRoute, _tasksShellRoute, _profileRoute, _settingsRoute],
  );
  ...
  ShellRoute get _tasksShellRoute => ShellRoute(
    builder: (context, state, child) {
      return BlocProvider(create: (_) => sl<TaskBloc>(), child: child);
    },
    routes: [
      GoRoute(
  ...
  GoRoute get _profileRoute => GoRoute(
    ...
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) {
          return RouteTransitions.fadeTransition(const EditProfileScreen());
        },
      ),
      GoRoute(
